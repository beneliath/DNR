...
-- Contact and organization communication histories are intentionally stored
-- separately so a contact's entries never appear in its organization's log.
...
CREATE TRIGGER audit_contact_chron_entries_after_update AFTER UPDATE ON contact_chron_entries
FOR EACH ROW INSERT INTO security_audit_log
    (actor_user_id, actor_username, event_category, event_type, entity_type, entity_id, entity_label, ip_address)
VALUES
...
CREATE TRIGGER audit_contact_chron_entries_after_delete AFTER DELETE ON contact_chron_entries
FOR EACH ROW INSERT INTO security_audit_log
    (actor_user_id, actor_username, event_category, event_type, entity_type, entity_id, entity_label, ip_address)
VALUES
...
CREATE TRIGGER audit_organization_chron_entries_after_insert AFTER INSERT ON organization_chron_entries
FOR EACH ROW INSERT INTO security_audit_log
    (actor_user_id, actor_username, event_category, event_type, entity_type, entity_id, entity_label, ip_address)
VALUES
...
CREATE TRIGGER audit_organization_chron_entries_after_update AFTER UPDATE ON organization_chron_entries
FOR EACH ROW INSERT INTO security_audit_log
    (actor_user_id, actor_username, event_category, event_type, entity_type, entity_id, entity_label, ip_address)
VALUES
...
CREATE TRIGGER audit_organization_chron_entries_after_delete AFTER DELETE ON organization_chron_entries
FOR EACH ROW INSERT INTO security_audit_log
    (actor_user_id, actor_username, event_category, event_type, entity_type, entity_id, entity_label, ip_address)
VALUES
