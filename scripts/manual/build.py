...
EDITION_DATE='September 21, 2026'
...
SUPPLEMENTS[5][0][1].insert(2, 'Selecting a replacement PDF or PowerPoint, or checking Remove, is pending until you select Save Changes beside the saved presentation or at the bottom of Edit Engagement. Either button saves the entire engagement form. The notice beside the file identifies the pending change. Choose replacement or removal, not both. Cancel or leave without saving to keep the current file; after saving, check the updated filename and upload details.')
