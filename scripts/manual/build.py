...
EDITION_DATE='September 19, 2026'
...
class Cover(Flowable):
    ...
    def draw(self):
        ...
        c.drawString(30,124,'Includes local updates since the v2.1.17 production deployment')
