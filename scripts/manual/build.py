...
class Cover(Flowable):
    ...
    def draw(self):
        ...
        c.setFillColor(MUTED);c.setFont('Body',9);c.drawString(30,143,f'Application source {VERSION}  |  September 9, 2026')
