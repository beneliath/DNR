...
- After migrations and any initial speaker import, renders and stores missing QR images using the public MOED origin while writers remain paused. Existing rendered images are preserved. A failed backfill leaves writers paused with the verified recovery backup available.
