    ...
    <table class="task-table">
        ...
        <?php foreach ($tasks as $task): ?>
            ...
            <tr class="task-row task-row-<?php echo htmlspecialchars($due['key'], ENT_QUOTES, 'UTF-8'); ?>">
                <td><span class="task-due task-due-<?php echo htmlspecialchars($due['key'], ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($due['label'], ENT_QUOTES, 'UTF-8'); ?></span><small class="task-priority task-priority-<?php echo htmlspecialchars($task['priority'], ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars($priority_labels[$task['priority']], ENT_QUOTES, 'UTF-8'); ?> priority</small></td>
                <td>
