...
/** Open validated PDFs in the browser, with the filename available when saving. */
function sendPresentationPdfViewHeaders(string $filename): void
{
    ...
    // CSP sandbox can block WebKit's own PDF viewer (WebKit bug 284594).
    // Keep resource loading and embedding restricted without sandboxing the viewer.
