                ...
                <div class="inquiry-card-list">
                    <?php foreach ($byStage[$stage] as $inquiry): ?>
                        ...
                        <article class="inquiry-card priority-<?php echo htmlspecialchars($inquiry['priority'], ENT_QUOTES, 'UTF-8'); ?>">
                            <h3><a class="record-link" href="view_inquiry.php?id=<?php echo (int) $inquiry['id']; ?>"><?php echo htmlspecialchars(bookingInquiryDisplayLabel($inquiry['title']), ENT_QUOTES, 'UTF-8'); ?></a></h3>
