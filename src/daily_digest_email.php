...
function renderDailyTaskDigestText(
    ...
    $lines[] = 'Manage delivery settings in My Profile > Notification Preferences.';
                ...
                <table role="presentation" width="720" class="email-shell" style="width:100%;max-width:720px;">
                    ...
                    <tr>
                        <td align="center" class="content-padding" style="padding:26px 20px 10px;">
                            ...
                            <div style="margin-top:16px;color:#8992a3;font-size:11px;line-height:1.6;">This is your scheduled <?php echo dailyTaskDigestHtmlEscape($brandName); ?> Daily Digest. Manage delivery settings in My Profile &gt; Notification Preferences.</div>
                        </td>
                    </tr>
                    <tr>
