...
<?php renderPageHead(applicationPageTitle('Calendar'), array (
  ...
  array (
    ...
    2 => 'assets/css/pages/calendar_subscription.min.css',
  ),
  'scripts' =>
  array (
    0 =>
...
<main class="container calendar-subscription">
    <div class="page-heading calendar-subscription-heading"><div><h1>Calendar</h1><p class="page-intro">View scheduled events and tasks by month, and manage private calendar links.</p></div></div>
    ...
    <div class="calendar-subscription-management-grid">
        <section class="security-card calendar-card" aria-labelledby="create-calendar-title">
            ...
            <form method="post" action="view_calendar.php" class="security-form">
                <?php echo csrfInput(); ?>
        ...
        <div class="calendar-card-heading">
            ...
            <?php if ($revoked_subscription_count > 0): ?>
                <form method="post" action="view_calendar.php" class="calendar-purge-form" data-confirm="Permanently delete all revoked calendar token records? Active subscriptions will not be affected. This cannot be undone.">
                    <?php echo csrfInput(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($subscription['revoked_at'] === null): ?>
                                    <form method="post" action="view_calendar.php" data-confirm="Revoke this calendar subscription? Existing calendar clients will stop refreshing.">
                                        <?php echo csrfInput(); ?>
