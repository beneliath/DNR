...
try {
    $chron_page_size = paginationPageSizePreference('edit_contact_chron', $_GET['chron_per_page'] ?? null, 20);
...
<div class="container edit-contact-page" role="main">
    ...
    <form id="contact-edit-form" method="post" enctype="multipart/form-data" action="edit_contact.php?id=<?php echo $contact_id; ?><?php echo ($_GET['from'] ?? '') === 'view' ? '&amp;from=view' : ''; ?>" data-chron-form>
        ...
        <div class="form-group">
            ...
            <textarea name="contact_notes" id="contact_notes" rows="6" placeholder="Add incidental notes about this person."><?php echo htmlspecialchars($contact['contact_notes'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
        </div>
