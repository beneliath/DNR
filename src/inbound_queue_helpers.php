...
function fetchInboundMailQueue(mysqli $conn, string $statusFilter, string $queueSearch, string $queueSort, int $queuePage, int $queuePageSize = 20): array
{
    ...
    $queuePageSize = in_array($queuePageSize, [20, 25, 50, 100], true) ? $queuePageSize : 20;
