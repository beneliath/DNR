...
<main class="container manual-container">
    ...
    <section class="manual-shell">
        ...
        <section class="manual-content" data-manual-content>
            ...
            <section class="manual-chapter" id="dashboard" data-manual-section data-keywords="dashboard today greeting summary cards upcoming engagements my work overdue needs attention readiness financial closeouts mail review due date pulsing blinking cascade orange hover reduced motion">
                <header class="manual-chapter-heading">
            ...
            <section class="manual-chapter" id="booking-pipeline" data-manual-section data-keywords="inquiry booking pipeline new contacted qualified awaiting details proposal sent booked declined next action owner priority source inbound email conversion schedule conflicts tasks chron reopen">
                ...
                <section class="manual-subsection">
                    ...
                    <ol class="manual-steps">
                        <li><span>01</span><section><strong>Capture the request.</strong><p>Select <strong>New Inquiry</strong> in the Booking Pipeline. Add the organization and contact when known; they can remain blank during early triage.</p></section></li>
            ...
            <section class="manual-chapter" id="engagements" data-manual-section data-keywords="engagement event search quote terms lifecycle active postponed canceled completed confirmation work in progress under review confirmed caller initial task owner creator schedule presentations speaker attendance contacts primary host travel materials logistics compensation closeout PDF Speaker Notes PPT Slidedeck PowerPoint pptx download replace upload QR code copy link speaker notes website donations copy clipboard marker markdown archive restore save changes outbound correspondence send email template library add edit archive restore delete display order event fields placeholders booking confirmation travel lodging reconfirmation thank you delivery retry event brief">
                ...
                <section class="manual-subsection">
                    ...
                    <p>In the <strong>Presentations</strong> tab, open <strong>Export Presentation</strong> at the bottom of a presentation card. Briefs include that presentation’s speaker, schedule, duration, and attendance, with its event and venue context.</p>
                    <section class="manual-card-grid manual-card-grid-two">
                        <article class="manual-card"><h4>Copy Text</h4><p>Copies a plain-text presentation brief for messages or notes.</p></article>
                        <article class="manual-card"><h4>Copy MD</h4><p>Copies a Markdown-formatted presentation brief for systems that support structured text.</p></article>
            ...
            <section class="manual-chapter" id="profile-security" data-manual-section data-keywords="profile picture name email verified password recovery notification digest dashboard snapshot upcoming engagement my work readiness closeout inbound mail review delivery time weekdays weekends phone security two factor 2FA authenticator QR setup key recovery codes change password disable login invitation reset theme">
                ...
                <section class="manual-subsection">
                    ...
                    <p>Two-factor authentication is required for Administrators, Editors, and Reviewers. Complete setup when prompted at sign-in, then save your recovery codes.</p>
                    <ol class="manual-steps">
                    ...
                    <p>At sign-in, enter either the current six-digit authenticator code or one unused recovery code. Generating new recovery codes invalidates all old ones. Every account type must keep 2FA enabled. If your account does not have an authenticator yet, your next successful password login will open setup before you can access the application. New invitations and accounts whose 2FA was reset follow the same setup process. Existing password-only sessions must sign in again.</p>
                </section>
            ...
            <section class="manual-chapter" id="administration" data-manual-section data-keywords="administrator users invite activation deactivate reactivate reset password reset 2FA delete audit log retention prune backup uploaded files photos documents database operations readiness migrations geocoding elevated five minutes countdown profile first last name phone picture crop upload network IPv4 IPv6 traffic statistics reset rose refresh latency TTFB contact images percentile">
                ...
                <section class="manual-card-grid manual-card-grid-two">
                    ...
                    <article class="manual-card">
                        ...
                        <p>The encrypted backup includes application records and uploaded files, including PDF Speaker Notes, PPT Slidedecks, and profile, contact, and speaker photos.</p>
