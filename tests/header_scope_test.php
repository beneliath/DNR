...
expectHeaderScope(
    str_contains($configuration_source, "define('APP_VERSION', '1.3.4');"),
    'The application version should be 1.3.4.'
);
expectHeaderScope(
    str_contains($footer_source, "defined('APP_VERSION') ? APP_VERSION : '1.3.4'"),
