...
expectHeaderScope(
    str_contains($configuration_source, "define('APP_VERSION', '0.1.5');"),
    'The application version should be 0.1.5.'
);
expectHeaderScope(
    str_contains($footer_source, "defined('APP_VERSION') ? APP_VERSION : '0.1.5'"),
