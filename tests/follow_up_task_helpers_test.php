...
foreach ([
    ...
    ['2026-09-06', 'open', '2026-09-05', 'Sep 6', 'Due tomorrow', 0],
    ['2026-09-06', 'in_progress', '2026-09-05', 'Sep 6', 'Due tomorrow', 0],
    ['2026-09-06', 'waiting', '2026-09-05', 'Sep 6', 'Due tomorrow', 0],
    ['2026-09-07', 'open', '2026-09-05', 'Sep 7', 'Upcoming', 0],
    ['2026-09-08', 'open', '2026-09-05', 'Sep 8', 'Upcoming', 0],
    ['2026-10-01', 'open', '2026-09-30', 'Oct 1', 'Due tomorrow', 0],
    ['2027-01-01', 'open', '2026-12-31', 'Jan 1, 2027', 'Due tomorrow', 0],
    ['2024-02-29', 'open', '2024-02-28', 'Feb 29', 'Due tomorrow', 0],
    ['2024-03-01', 'open', '2024-02-29', 'Mar 1', 'Due tomorrow', 0],
    ['2026-03-09', 'open', '2026-03-08', 'Mar 9', 'Due tomorrow', 0],
    ['2026-11-02', 'open', '2026-11-01', 'Nov 2', 'Due tomorrow', 0],
    ...
    ['2026-09-06', 'completed', '2026-09-05', 'Sep 6', 'Completed', 0],
    ['2026-09-06', 'canceled', '2026-09-05', 'Sep 6', 'Canceled', 0],
    ...
    if ($detail === 'Due tomorrow') {
        expectFollowUpTaskHelper(
            followUpTaskDueState($date, $today) === ['key' => 'upcoming', 'label' => 'Due tomorrow'],
            'related-record task lists and digests should label tomorrow consistently while preserving queue grouping.'
        );
    }
}
expectFollowUpTaskHelper(
    followUpTaskDuePresentation('2026-09-06', 'open', '2026-09-05', true)['detail'] === 'Archived',
    'archived work due tomorrow should retain its archived label.'
);
