...
expectPaginationPreference(paginationPageSizePreference('map', 100, 100) === 100
    && paginationPageSizePreference('map', null, 50, [20, 50]) === 50,
    'Stored preferences respect the current route size limit.');

$_COOKIE['dnr_rows_per_page_users'] = ['malformed'];
expectPaginationPreference(paginationPageSizePreference('users', null, 50) === 50,
