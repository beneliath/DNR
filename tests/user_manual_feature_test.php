...
expectUserManual(
    str_contains($manual, '/moed connect CODE')
        ...
        && str_contains($manual, '<strong>Add MOED task</strong> creates a follow-up task')
        && str_contains($manual, 'Add to MOED Chron')
        && str_contains($manual, 'creates a new Chron entry')
        && str_contains($manual, 'Opening or canceling a modal writes nothing')
