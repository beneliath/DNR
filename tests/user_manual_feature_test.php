...
expectUserManual(
    str_contains($manual, '/moed connect CODE')
        ...
        && str_contains($manual, 'the MOED bot privately notifies')
        && str_contains($manual, 'Read the Receipt Reactions')
        && str_contains($manual, '<code>:memo:</code> reaction')
        && str_contains($manual, '<code>:email:</code> reaction')
        && str_contains($manual, 'Both may appear')
        && str_contains($manual, 'Earlier Chron entries and emails are not marked retroactively')
        && str_contains($manual, 'Opening, reviewing, or canceling a form changes nothing')
...
expectUserManual(
    str_contains($manual, 'PDF Speaker Notes')
        ...
        && str_contains($manual, 'Copy link icon')
